...
public class WelcomePage extends BasePage {
	...
	public double returnPriceProduct() {
		return Double.valueOf(productPrice.getText().substring(1));
	}

	// FUNCTION TO RETURN THE TOTAL SUM REQUIRED TO PAY
	public double returnTotalPriceTpPay() {
		return Double.valueOf(totalSumToPay.getText().substring(1));
	}
}