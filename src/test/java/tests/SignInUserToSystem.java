...
public class SignInUserToSystem extends BaseTest {
	@Test
	public void tc01SignInSuccessfullyToSystem() throws InterruptedException {
	...
	@Test
	public void tc02SignInFailed() throws InterruptedException {
		// SIGN IN TO THE SYSTEM WITH USER ALREADY EXIST
		WelcomePage login = new WelcomePage(driver);
		SignInPage sign = new SignInPage(driver);
		String mail = "";
	...
	public void tc03SignInFailed(String mail, String password) throws InterruptedException {
		// SIGN IN TO THE SYSTEM WITH USER ALREADY EXIST
		WelcomePage login = new WelcomePage(driver);
		SignInPage sign = new SignInPage(driver);
